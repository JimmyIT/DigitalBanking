        ...
        await Task.Run(() =>
        {
            if (_columnsDefinition == null)
            {
                ...
                new ColumnDefinition[]{
                    ...
                    new ColumnDefinition{ DataField = "Narrative", Caption="NARRATIVE", SortDirection = SortDirection.Asc,},
                    new ColumnDefinition{ DataField = "CreditAmount", Caption="IN", SortDirection = SortDirection.Asc, DataType = DataType.Currency, HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, Format = "c"},
                    new ColumnDefinition{ DataField = "DebitAmount", Caption="OUT", SortDirection = SortDirection.Asc,  DataType = DataType.Currency, HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, Format = "c" },
                    new ColumnDefinition{ DataField = "Balance", Caption="BALANCE", SortDirection = SortDirection.Asc,  DataType = DataType.Currency, HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, Format = "c" }
                    });
