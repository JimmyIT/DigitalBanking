...
public partial class PaymentModalConfirmComponent
{
    ...
    [Parameter] public bool IsInputPayee { get; set; }
    [Parameter] public CreatePaymentRequestModel CreatePaymentModel { get; set; }
    [Parameter] public CreatePayeeAndPaymentRequestModel CreatePayeeAndPaymentModel { get; set; }
    ...
    private async Task Confirm()
    {
        ...
        {
            parameters
                .Add(nameof(PaymentModalConfirmedComponent.CreatePayeeAndPaymentModel), this.CreatePayeeAndPaymentModel);
        }
        else
        {
            parameters.Add(nameof(PaymentModalConfirmedComponent.CreatePaymentModel), CreatePaymentModel);
        }

        parameters.Add(nameof(PaymentModalConfirmedComponent.IsInputPayee), IsInputPayee);
