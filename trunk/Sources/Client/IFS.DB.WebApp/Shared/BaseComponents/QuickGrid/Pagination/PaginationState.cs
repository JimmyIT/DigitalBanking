...
using IFS.DB.WebApp.Shared.BaseComponents.QuickGrid.Infrastructure;
...
public class PaginationState
{
    ...
    public List<int> PageSizes { get; set; } = new() { 5, 10, 20, 50, 100 };
    ...
    internal Task SetPageSizeAsync(int newPageSize)
    {
        if (ItemsPerPage == newPageSize)
        {
            return Task.CompletedTask;
        }
