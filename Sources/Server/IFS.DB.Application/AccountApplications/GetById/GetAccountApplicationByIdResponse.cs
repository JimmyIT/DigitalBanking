...
{
    public class GetAccountApplicationByIdResponse
    {
        ...
        {
            TypeAdapterConfig<AccountApplication, GetAccountApplicationByIdResponse>
                .NewConfig()
                ...
                .Map(dst => dst.RequestId, src => src.TokenPurchaseRequestId)
                ;
        }
    }
}
