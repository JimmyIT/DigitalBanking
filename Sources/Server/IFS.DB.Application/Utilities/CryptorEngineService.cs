...
namespace IFS.DB.Application.Utilities
{
    ...
    {
        public const string DefaultCipherCode = "S@LTV@LUE-IFIN@NCI@LB@NK";
        ...
        {
            // Convert saltValue to bytes array.
        ...
        /// <param name="cipherCode">a secret key to encrypt a plain text</param>
        /// <param name="initVector"> 
        /// Initialization vector (or IV). This value is required to encrypt the
        /// first block of plaintext data. For RijndaelManaged class IV must be 
        /// exactly 16 ASCII characters long.
        /// </param>
        /// <returns></returns>
        public static string Encrypt(string plainText, string cipherCode, string initVector)
        {
            // Convert cipherCode into byte array.
        ...
        /// </summary>
        /// <param name="plainText">Plaintext value to be encrypted.</param>
        /// <param name="keyBytes">a bytes array of a secret string key for encryption. The array maximum size is 32 bytes.</param>
        /// <param name="initVector">
        /// Initialization vector (or IV). This value is required to encrypt the
        /// first block of plaintext data. For RijndaelManaged class IV must be 
        /// exactly 16 ASCII characters long.
        ...
        /// <param name="cipherCode">A secret key to decrypt a plain text</param>
        /// <param name="initVector">
        /// Initialization vector (or IV). This value is required to encrypt the
        /// first block of plaintext data. For RijndaelManaged class IV must be
        /// exactly 16 ASCII characters long.
        /// </param>
        /// <returns></returns>
        public static string Decrypt(string cipherText, string cipherCode, string initVector)
        {
            byte[] keyBytes = Encoding.ASCII.GetBytes(cipherCode);
        ...
        /// <param name="cipherText">Base64-formatted ciphertext value.</param>
        /// <param name="keyBytes">
        /// a bytes array of a secret string key for encryption. 
        /// The array maximum size is 32 bytes.
        /// </param>
        /// <param name="initVector">
        /// Initialization vector (or IV). This value is required to encrypt the
        /// first block of plaintext data. For RijndaelManaged class IV must be 
