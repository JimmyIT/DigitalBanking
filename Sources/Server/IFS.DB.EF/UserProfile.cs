...
namespace IFS.DB.EF
{
    public partial class UserProfile
    {
        public UserProfile()
        {
            SplitAuthorityCodes = new HashSet<SplitAuthorityCode>();
        }
        ...
        public virtual AuthorityCode AuthorityCode { get; set; } = null!;
        public virtual ICollection<SplitAuthorityCode> SplitAuthorityCodes { get; set; }
    }
}
