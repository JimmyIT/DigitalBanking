...
namespace IFS.DB.Infrastructure.External.Bankware.Accounts.GetByAccountNumber
{
    public class GetByAccountNumberResponse
    {
        ...
        public bool Ala76IbnkExpt { get; set; }
        ...
        {
            TypeAdapterConfig<GetByAccountNumberResponse, Domain.GetByAccountNumberResponse>
                .NewConfig()
                .Map(dst => dst.AverageBalance, scr => ConvertHelper.ConvertStringToDecimal(scr.AverageBalance))
                .Map(dst => dst.InternetFlag, src => src.Ala76IbnkExpt)
                ;
        }
