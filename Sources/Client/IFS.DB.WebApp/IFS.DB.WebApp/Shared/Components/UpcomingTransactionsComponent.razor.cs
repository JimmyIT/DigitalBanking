        ...
        if (_columnsDefinition == null)
        {
            ...
            else
            {
                ...
                new ColumnDefinition<TransactionModel>[]{
                    ...
                    new ColumnDefinition<TransactionModel>{ DataField = "CreditAmount", Caption="IN", HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, ShowValueFunc = ReturnCreditAmountValue },
                    new ColumnDefinition<TransactionModel>{ DataField = "DebitAmount", Caption="OUT", HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, ShowValueFunc = ReturnDebitAmountValue },
                    new ColumnDefinition<TransactionModel>{ DataField = "Balance", Caption="BALANCE", HeaderAlignment = Alignment.Right, BodyAlignment = Alignment.Right, DataType = DataType.Currency, Format = "N2" }
                    });
